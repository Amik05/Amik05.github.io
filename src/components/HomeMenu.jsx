...
const HomeMenu = ({ openWindow }) => {
  return (
    <div>
      {/* HOME MENU */}
      <div className="absolute overflow-hidden left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] max-w-[70vw] rounded-lg bg-white/85 dark:bg-black/50 backdrop-blur-sm dark:backdrop-blur-xl border-3 border-orange-400 dark:border-white/80 shadow-2xl flex flex-col">
        {/* Title Bar */}
